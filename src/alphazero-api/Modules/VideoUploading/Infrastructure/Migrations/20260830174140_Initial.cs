        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomThumbnailKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    ThumbnailUrl = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    UseCustomThumbnail = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomThumbnailKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    TargetResourceArn = table.Column<string>(type: "text", nullable: true),
